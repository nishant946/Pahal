  ...
  useEffect(() => {
    const fetchTeachers = async () => {
      try {
        ...
        try {
          const todayAttendance = await teacherService.getPresentTeachersByDate(
            todayDate
          );
          const presentTeacherIds = new Set(
            todayAttendance.presentTeachers.map((t) => t.id)
          );
                ...
                <div className="flex gap-2">
                  {teacher.isPresent ? (
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        teacher._id && unmarkAttendance(teacher._id)
                      }
                    ...
                    <Button
                      size="sm"
                      onClick={() =>
                        teacher._id && markAttendance(teacher._id, "present")
                      }
                      disabled={markingAttendance}
                      className="flex-1"
                    >
