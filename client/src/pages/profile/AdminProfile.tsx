                  ...
                  <div className="w-24 h-24 rounded-full overflow-hidden bg-gray-200 flex items-center justify-center border-4 border-blue-200">
                    {avatar ? (
                      ...
                      <div className="relative">
                        ...
                        <Shield className="h-4 w-4 text-blue-600 absolute -bottom-1 -right-1 bg-background rounded-full p-0.5" />
                      </div>
                    )}
                  </div>
                  {avatar && (
          ...
          <Card className="border-amber-200 bg-amber-50">
            ...
            <CardContent>
              <p className="text-sm text-amber-700">
                ...
                Please ensure your contact information is up to date for
                security purposes. Any changes to your profile will be logged
                for audit purposes.
              </p>
            </CardContent>
          </Card>
