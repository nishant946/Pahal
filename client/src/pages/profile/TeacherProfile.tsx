...
const SUBJECTS = [
  ...
  // Languages
  'Urdu', 'Bengali', 'Tamil', 'Telugu', 'Marathi', 'Gujarati', 'Punjabi', 'Assamese', 'Odia', 'Malayalam', 'Kannada', 'French', 'German', 'Spanish',
  // Social Sciences
  'History', 'Geography', 'Political Science', 'Economics', 'Civics',
  // Vocational/Optional Subjects
  'Computer Science', 'Information Technology', 'Home Science', 'Physical Education', 'Art Education', 'Music', 'Dance', 'Drawing', 'Painting', 'Work Education', 'Health and Physical Education',
  // Additional Subjects
  'Environmental Studies', 'Moral Science', 'General Knowledge', 'Library Science',
  'Other'
];
...
const TeacherProfile: React.FC = () => {
  ...
  const validateForm = () => {
    if (!formData.name || !formData.email || !formData.mobileNo || !formData.department) {
    ...
    if (formData.preferredDays.length === 0) {
      setMessage({ type: 'error', text: 'Please select at least one preferred day' });
      return false;
    }
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Preferred Days <span className="text-red-500">*</span></CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Subject Choices <span className="text-red-500">*</span></CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Core Subjects */}
                ...
                {/* Science Subjects */}
                <div className="space-y-3">
                  <h4 className="font-medium text-sm text-gray-700">Science Subjects</h4>
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
                ...
                <div className="space-y-3">
                  <h4 className="font-medium text-sm text-gray-700">Other Subjects</h4>
