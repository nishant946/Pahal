...
function TodayAttendance() {
  ...
  const filteredStudents = todayAttendance.presentStudents.filter(student =>
  ...
  const downloadCSV = () => {
    ...
    const csvData = filteredStudents.map(student =>
      [student.rollNumber, student.name, student.grade, student.group, student.timeMarked].join(',')
    );
      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 rounded-lg p-4 sm:p-6">
            <h3 className="text-blue-700 font-semibold text-lg mb-2">Attendance Summary</h3>
                  ...
                  <div key={student.id} className="p-4 hover:bg-gray-50 transition-colors">
                    ...
                    <div className="sm:hidden space-y-2">
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-2">Time: {student.timeMarked}</p>
                      </div>
                    </div>
                    ...
                    <div className="hidden sm:grid grid-cols-12 gap-4 items-center">
                      ...
                      <div className="col-span-2 text-gray-600">{student.timeMarked}</div>
                    </div>
                  </div>
                ))}
              </div>
